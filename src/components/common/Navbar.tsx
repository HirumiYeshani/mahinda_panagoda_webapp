...
const Navbar: React.FC = () => {
  ...
  return (
   <nav className="absolute top-0 left-0 w-full bg-gradient-to-b from-black to-black/5 text-white py-12 pt-3 z-80">
  <div className="w-5/6 mx-auto flex items-center justify-between px-4 md:px-14 lg:px-10">
    {/* Logo */}
 {/* Logo */}
<div className="flex items-center pt-2 lg:pt-0 -translate-x-10">
  <NavLink to="/">
    ...
    {/* Buttons */}
    <div className="hidden lg:flex space-x-8 translate-x-10 ">
      <button
